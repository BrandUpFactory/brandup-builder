...
export default function EditorLayout({ 
  ...
  return (
    <div className="p-4 md:p-6 bg-white text-[#1c2838]">
      ...
      {hasUnsavedChanges && (
        <div className="fixed top-16 right-4 bg-yellow-500 text-white px-4 py-2 rounded shadow-lg z-50 animate-fadeIn">
        ...
        <div className="flex items-center gap-2">
            <div className="bg-gray-50 rounded-lg flex overflow-hidden shadow-sm">
              ...
              <button 
                ...
                className="px-4 py-2 text-sm text-white bg-[#1c2838] hover:bg-opacity-90 flex items-center gap-1.5 transition font-medium border-l border-gray-200"
                id="saveButton"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
